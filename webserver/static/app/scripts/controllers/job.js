angular.module('sbAdminApp')
  .controller('JobCtrl', function($scope,$position, $stateParams, jobservice, $state) {
    ...
    {  
      var jobName = prompt("Enter new Job Name", $scope.jobInfo["name"] + "_1");
      var paramName = prompt("Enter new Param Name", $scope.paramInfo["name"] + "_1");
      $scope.jobInfo["name"] = jobName;
      $scope.paramInfo["name"] = paramName;
      console.log("Forking new model, asking for name: " + jobName)
